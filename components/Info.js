...
export default function Info(){
    return (
        <div className="info">
            <img className= "info-image" src="https://learn.microsoft.com/answers/storage/attachments/209536-360-f-364211147-1qglvxv1tcq0ohz3fawufrtonzz8nq3e.jpg" />
            <h1>Daniel Sabry</h1>
            <h4>Frontend Developer</h4>
            <small>danielsabry.website</small>
